...
<?php
    ...
    try
    {
        ...
        /*
        $id_facture = 'FA-65678989';
        $url = $_SERVER['DOCUMENT_ROOT'] . '/PFE/pro-facture/companies/';
        $html2pdf->Output($url.'/facture n' . $id_facture . '.pdf');
        $html2pdf->Output($url.'/facture n' . $id_facture . '.pdf', 'f');
        */
    }
