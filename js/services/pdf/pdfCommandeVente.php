...
if (isset($_REQUEST['data'])) {
    ...
    <page backcolor="<?= $paramsPdf['backcolor'];?>" backtop="5mm" backleft="8mm" backright="8mm" backbottom="30mm" footer="page; date;">
        <page_footer>
            <hr/>
            <p>
            <h2 style="margin-top:-1mm;margin-bottom:4pt;">Commande</h2>
            <span class="footer">
    ...
    ?>
        ...
        <img src="<?= $_SERVER['DOCUMENT_ROOT'] . "PFE/pro-facture/".$societe['logo'];?>" style="width:38mm;">
    ...
    try {
        ...
        $url = $_SERVER['DOCUMENT_ROOT'] . 'PFE/pro-facture/companies/'.$societe['nomSoc'];
        $type= '/docs/ventes/commande/';
