                        ...
                        $stateProvider
                                ...
                                .state('app.clients', {
                                    ...
                                    resolve: {
                                        deps: ['$ocLazyLoad',
                                            function ($ocLazyLoad) {
                                                return $ocLazyLoad.load('ServiceClients').then(
                                                        function () {
                                ...
                                .state('app.gesClient', {
                                    url: '/gestionClient/:refCli',
                                    templateUrl: 'tpl/gesClient.html',
                                    resolve: {
                                        deps: ['$ocLazyLoad',
                                            function ($ocLazyLoad) {
                                                return $ocLazyLoad.load(['toaster', 'ServiceClients']).then(
                                                        function () {
                                ...
                                .state('app.fournisseurs', {
                                    ...
                                    resolve: {
                                        deps: ['$ocLazyLoad',
                                            function ($ocLazyLoad) {
                                                return $ocLazyLoad.load('ServiceFournisseurs').then(
                                                        function () {
                                ...
                                .state('app.gesFournisseur', {
                                    url: '/gestionFournisseur/:refFour',
